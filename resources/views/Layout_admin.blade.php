            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header">
                    <div class="d-flex justify-content-between">
                        <div class="logo">
                            <a href="{{ route('dashboard.index') }}"><i class="fas fa-dragon"></i> Admin</a>
                        </div>
                        <div class="toggler">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ $url_now == route('blogs-cate.index') ? 'active' : '' }}">
                            <a href="{{ route('blogs-cate.index') }}" class='sidebar-link'>
                                <i class="bi bi-journal-album"></i>
                                <span>Category Blog</span>
                            </a>
                        </li>
                        <li class="sidebar-item {{ $url_now == route('blogs.index') ? 'active' : '' }}">
                        ...
                        <li class="sidebar-item has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item ">
                                    <a href="{{ route('logout.create') }}">Log Out</a>
                                </li>
                            </ul>
                        </li>
