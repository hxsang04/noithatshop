                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-lg">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="col-3"><a href="{{ route('home.detail',$view_pro->product_slug) }}">{{ $view_pro->product_name }}</a></td>
                                                <td class="col-auto">
                    ...
                    <div class="card-body py-4 px-5">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-xl">
                                <img src="{{ asset('backend/assets/images/faces/23.jpg') }}" alt="Face 1">
                            </div>
                            <div class="ms-3 name">
                    ...
                    <div class="card-content pb-4">
                        ...
                        <div class="recent-message d-flex px-4 py-3">
                            <div class="avatar avatar-lg">
                                <img src="{{ asset('backend/assets/images/faces/'.$filename) }}">
                            </div>
                            <div class="name ms-4">
