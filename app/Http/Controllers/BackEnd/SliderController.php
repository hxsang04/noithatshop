...
class SliderController extends Controller
{
    ...
    {
        if(request()->ajax()){
            return datatables()->of(Slider::orderBy('slider_id','asc')->get())
    ...
    public function store(Request $request)
    {
        if(request()->ajax()){
            $slider = new Slider();
            $slider->slider_name = $request->slider_title;
            $slider->slider_content = $request->slider_content;
            $slider->slider_link = $request->slider_url;
